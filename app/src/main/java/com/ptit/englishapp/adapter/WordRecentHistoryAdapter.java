...
public class WordRecentHistoryAdapter extends RecyclerView.Adapter<WordRecentHistoryAdapter.WordRecentViewHolder> {

    private List<WordRecent> mList;

    private WordRecentAdapter.OnClickListener mListener;
    ...
    public void setMListener(WordRecentAdapter.OnClickListener mListener) {
    ...
    public WordRecentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_word_recent_history, parent, false);
    ...
    public class WordRecentViewHolder extends RecyclerView.ViewHolder {
        ...
        public WordRecentViewHolder(@NonNull View itemView) {
            super(itemView);
            recent = itemView.findViewById(R.id.recentWordHistory);
            typeDictionary = itemView.findViewById(R.id.typeDictionaryHistory);
            uid = itemView.findViewById(R.id.uidWordRecentHistory);
        }
    }
