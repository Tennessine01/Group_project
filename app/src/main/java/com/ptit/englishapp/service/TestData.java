...
public class TestData {
    public static List<Category> getListCategory() {
        ...
        categories.add(new Category(R.drawable.ic_109k, "Dic109K", ""));
        categories.add(new Category(R.drawable.ic_translate, "Translate", "Payment"));
        categories.add(new Category(R.drawable.ic_pronounce, "Pronounce", "Payment"));
        return categories;
    }
